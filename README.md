...
- Orchestration foundations: DAG scheduling with read/write locks, content-addressed evidence cache, reconciliation, benchmark comparison runner, Codex adapter config, adaptive model routing, and connector registry
