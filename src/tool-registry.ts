...
const TOOL_OVERRIDES: Record<string, Partial<ToolRegistryEntry>> = {
  gate_request: {
    ...
    pack: "core",
    risk: "read",
    summary: "Evaluate mission evidence, questions, source conflicts, freshness signals, and claim checks before final claims.",
    inputs: ["missionId", "sourceConflicts", "freshness", "evidenceRequirements", "claimChecks"],
  },
  claim_record: {
    plane: "mission",
    phase: "gate",
    pack: "core",
    risk: "write",
    summary: "Record a typed, evidence-bound repo or workflow claim for later gate checks and invalidation.",
    inputs: ["kind", "subject", "predicate", "object", "claimText", "producer", "evidenceIds", "invalidationKeys"],
  },
  claim_verify: {
    plane: "mission",
    phase: "gate",
    pack: "core",
    risk: "write",
    summary: "Re-check or update a recorded claim status against its current evidence state.",
    inputs: ["claimId", "status", "evidenceIds", "reason"],
  },
  claim_search: {
    plane: "mission",
    phase: "gate",
    pack: "core",
    risk: "read",
    summary: "Search the claim ledger for supported, stale, unsupported, conflicted, or unverified claims.",
    inputs: ["claimIds", "status", "kind", "subject", "producerToolName", "limit"],
  },
  claim_invalidate: {
    plane: "mission",
    phase: "maintain",
    pack: "core",
    risk: "write",
    summary: "Mark claims stale when changed files or invalidation keys affect their supporting evidence.",
    inputs: ["changedFiles", "invalidationKeys", "reason"],
  },
  tool_layer_map: {
    plane: "mission",
    phase: "orient",
  ...
  tool_surface_audit: {
    ...
    pack: "core",
    risk: "read",
    summary: "Audit the Wormhole tool surface into guided, expert, and catalog-only advisory tiers.",
    inputs: ["none"],
  },
  tool_admission_review: {
    plane: "policy",
  ...
  workflow_plan: {
    ...
    pack: "core",
    risk: "read",
    summary: "Return a typed deterministic workflow plan with tool contracts, required evidence, missing inputs, and stop rules.",
    inputs: ["objective", "repoRoot", "query", "changedFiles", "observedFailure", "reviewOnly", "intent"],
  },
  workflow_write_artifacts: {
    plane: "mission",
    phase: "maintain",
  ...
  agent_dispatch: {
    plane: "adapter",
    phase: "act",
    pack: "external-agents",
    risk: "write",
    summary: "Queue a Wormhole task for a registered external agent by required capability.",
    inputs: ["missionId", "taskId", "objective", "requiredCapabilities", "preferredTargets", "payload", "timeoutMs"],
  },
  agent_dispatch_execute: {
    plane: "adapter",
    phase: "act",
    pack: "external-agents",
    risk: "execute",
    summary: "Dispatch and execute a CLI or HTTP external agent with bounded per-run timeout evidence.",
    inputs: ["missionId", "taskId", "objective", "requiredCapabilities", "preferredTargets", "payload", "timeoutMs"],
  },
  resume_record: {
    plane: "coordination",
  ...
  project_onboard: {
    ...
    risk: "write",
    summary:
      "Run project onboarding and persist contract, index, safety, impact, verification, dependency, semantic, LSP, and policy signals.",
    inputs: [
      "repoRoot",
      "changedFiles",
      "diffText",
  ...
  repo_native_pack_build: {
    ...
    inputs: ["repoRoot", "objective", "query", "changedFiles", "diffText", "maxChangedSymbols", "limit"],
  },
  feature_slice_query: {
    plane: "project",
    phase: "gather",
  ...
  blast_radius_analyze: {
    ...
    pack: "large-repo",
    risk: "read",
    inputs: ["repoRoot", "changedFiles", "diffText", "maxChangedSymbols"],
  },
  change_impact_analyze: {
    plane: "project",
    phase: "impact",
    pack: "large-repo",
    risk: "read",
    summary: "Analyze changed files with relation-backed impacted files, likely tests, confidence, and risk.",
    inputs: ["repoRoot", "changedFiles", "diffText", "maxDepth", "requireFresh"],
  },
  context_pack_generate: {
    plane: "context",
    phase: "context",
    pack: "context",
    risk: "read",
    inputs: ["repoRoot", "objective", "query", "changedFiles", "maxChars", "maxChangedSymbols"],
  },
  repo_watch_scan: {
    plane: "project",
    phase: "maintain",
  ...
  repo_graph_refresh_incremental: {
    ...
    pack: "large-repo",
    risk: "write",
    summary: "Refresh changed repo graph files incrementally when safe, with explicit full-rebuild fallback reasons.",
    inputs: [
      "repoRoot",
      "changedFiles",
      "diffText",
  ...
  repo_relation_query: {
    ...
    pack: "large-repo",
    risk: "read",
    summary: "Query canonical repo facts by typed relation, endpoint, direction, and bounded graph path.",
    inputs: ["repoRoot", "from", "to", "kinds", "direction", "maxDepth", "limit", "cursor", "requireFresh"],
  },
  repo_intelligence_search: {
    plane: "project",
    phase: "gather",
    pack: "large-repo",
    risk: "read",
    summary: "Fuse durable lexical, SQLite, graph-node semantic, and relation evidence for repo search.",
    inputs: ["repoRoot", "query", "changedFiles", "limit", "requireFresh"],
  },
  durable_repo_index_refresh: {
    plane: "project",
    phase: "maintain",
  ...
  dependency_audit_live: {
    ...
    pack: "verification",
    risk: "execute",
    summary: "Run bounded npm, pnpm, or bun audit/outdated commands and parse dependency risk output.",
